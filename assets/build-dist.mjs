...
async function rewriteScriptImports(directory) {
  ...
  for (const item of items) {
    ...
    content = content.replaceAll("import './admin/content-edit/preview-section';", "import './admin/content-edit/preview-section.js';");
    content = content.replaceAll("import './types/section-type';", "import './types/section-type.js';");
