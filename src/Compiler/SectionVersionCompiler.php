...
namespace Softspring\CmsSectionsPlugin\Compiler;

use Exception;
use Psr\Log\LoggerInterface;
use Softspring\CmsBundle\Compiler\AbstractVersionCompiler;
...
class SectionVersionCompiler extends AbstractVersionCompiler
{
    ...
    public function compileRequest(VersionInterface $version, Request $request): CompiledDataInterface
    {
        ...
        try {
            if ($this->compileHelper->sectionSaveCompiled($version)) {
