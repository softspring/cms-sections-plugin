...
class CreateListener extends AbstractSectionVersionListener
{
    ...
    public static function getSubscribedEvents(): array
    {
        return [
            ...
            // SfsCmsSectionsEvents::ADMIN_SECTION_VERSIONS_CREATE_FORM_INIT => [],
            // SfsCmsSectionsEvents::ADMIN_SECTION_VERSIONS_CREATE_FORM_VALID => [],
            ...
            // SfsCmsSectionsEvents::ADMIN_SECTION_VERSIONS_CREATE_EXCEPTION => [],
        ];
    }
    ...
    public function onView(ViewEvent $event): void
    {
        ...
        $event->getData()['enabled_sites'] = $this->cmsHelper->config()->getSites();
    }
