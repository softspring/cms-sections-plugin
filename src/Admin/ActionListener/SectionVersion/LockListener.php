...
class LockListener extends AbstractSectionVersionListener
{
    ...
    public static function getSubscribedEvents(): array
    {
        return [
            ...
            // SfsCmsSectionsEvents::ADMIN_SECTION_VERSIONS_LOCK_LOAD_ENTITY => [],
            SfsCmsSectionsEvents::ADMIN_SECTION_VERSIONS_LOCK_NOT_FOUND => [
                ['onNotFoundAddFlashAndRedirectToList', 0],
            ],
            // SfsCmsSectionsEvents::ADMIN_SECTION_VERSIONS_LOCK_FOUND => [],
            ...
            // SfsCmsSectionsEvents::ADMIN_SECTION_VERSIONS_LOCK_EXCEPTION => [],
        ];
    }
